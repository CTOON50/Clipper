...
namespace Clipper
{
    ...
    public partial class frmMain : Form
    {
                        ...
                        this.InvokeEx(f =>
                            {
                                ...
                                f.lblPlayerSpeed.Text = string.Format("{0} ({1}%)", speed.ToString(), ((speed * 100) / 4));
                            });
        ...
        {
            var speedMult = this.tbPlayerSpeed.Value * 0.5f;
        ...
        {
            var speedMult = this.tbPlayerSpeedDisabled.Value * 0.5f;
            var speed = 4.0f + (speedMult - 0.5f);
